...
public final class ThermalHelper {
    ...
    /**
     * Power Model Spec to be used
     */
    private static PowerModel powerModel;
     ...
     */
    public ThermalHelper(final Simulation simulation, final String experimentName, final boolean outputInCsv, final String outputFolder) {
     ...
     */
    public static List<PowerHost> createHostList(int hostsNumber, PowerModel powerModel) {
